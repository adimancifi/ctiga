...
class Siuri extends CI_Controller
{
	...
	public function controller($name = Null, $extendsName = 'CI_Controller')
	{
		...
		{
			echo "USAGE :\n";
			echo " siuri make controller [myController] [myExtends]\n\n";
			...
			echo "EXAMPLE :\n";
			echo " siuri make controller MyController\n";
			...
			echo " siuri make controller dir.subdir.MyController MyExtends\n";
	...
	public function model($name = Null, $table = Null, $extendsName = 'CI_Model')
	{
		...
		if (empty($name))
		{
			...
			echo "USAGE :\n";
			echo " siuri make model [modelName] [table] [extendsName] \n\n";
